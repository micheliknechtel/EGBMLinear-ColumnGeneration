...
{
    string str = DataManager::getDataManager()->getDirectory() +"../"+ DataManager::getDataManager()->partitionCheck_01;
    freopen(str.c_str(),"w", stdout);
}

void DataEvaluetor::processingData(DataControler *d)
{
    string str = DataManager::getDataManager()->getDirectory() +"../"+ DataManager::getDataManager()->partitionCheck_02;
    freopen(str.c_str(),"w", stdout);
    d->loadPartitians();
}
