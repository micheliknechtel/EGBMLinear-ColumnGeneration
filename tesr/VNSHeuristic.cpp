...
void VNSHeuristic::runVNSHeuristic()
{
    ...
    dataControler->buildPartitian(DataManager::getDataManager()->getNetworSize());
    ...
    DataManager::getDataManager()->clusterSets = dataControler->solution;
    DataManager::getDataManager()->buildEpsilon();
